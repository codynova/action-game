...
import { Background, Camera, Capsule, Cube, Mirror, Player, Floor, AnimatedGeometry, ShadedGeometry, RaymarchBlob, RaymarchTest, RaymarchEffect } from 'Components';
	...
	return (
		<div className={styles.container}>
			<Canvas shadowMap>
				...
				<Camera />
				{/* <RaymarchEffect /> */}
				{/* <RaymarchBlob position={[ -2.5, 5.5, 5.5 ]} /> */}
				<RaymarchTest position={[ -2.5, 5.5, 5.5 ]} />
				<PhysicsProvider>
